...
class ChoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chore" do
    assert_difference('Chore.count') do
      post chores_url, params: { chore: { completed: @chore.completed, description: @chore.description, house_id: @chore.house_id } }
    end
  ...
  test "should update chore" do
    patch chore_url(@chore), params: { chore: { completed: @chore.completed, description: @chore.description, house_id: @chore.house_id } }
